...
lazy_static! {
    static ref PROMETHEUS_PEERS: Gauge =
        register_gauge!(opts!("netsody_sp_peers", "Number of peers.",)).unwrap();
    static ref PROMETHEUS_PEER_PATHS: GaugeVec = register_gauge_vec!(
        "netsody_sp_peer_paths",
        "Number of paths.",
        &[
            "peer",
    ...
    pub static ref PROMETHEUS_MESSAGES: CounterVec =
        register_counter_vec!("netsody_sp_messages", "Number of messages received/sent.", &[
