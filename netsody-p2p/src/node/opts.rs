...
lazy_static! {
    /// Default list of super peers for the Netsody network.
    ...
    pub static ref SUPER_PEERS_DEFAULT: Vec<SuperPeerUrl> = vec![
        ...
        SuperPeerUrl::from_str("udp://sp-eu-central-1.netsody.io:22527?publicKey=5b4578909bf0ad3565bb5faf843a9f68b325dd87451f6cb747e49d82f6ce5f4c&networkId=1&tcpPort=8443").unwrap(),
        SuperPeerUrl::from_str("udp://sp-na-east-1.netsody.io:22527?publicKey=bf3572dba7ebb6c5ccd037f3a978707b5d7c5a9b9b01b56b4b9bf059af56a4e0&networkId=1&tcpPort=8443").unwrap(),
        SuperPeerUrl::from_str("udp://sp-ap-south-1.netsody.io:22527?publicKey=ab7a1654d463f9986530bed00569cc895697827b802153b8ef1598579713045f&networkId=1&tcpPort=8443").unwrap(),
    ];
}

/// Configuration options for creating a new [`crate::node::Node`].
///
/// This struct contains all the necessary configuration parameters for initializing a Netsody node.
...
/// A trait for receiving messages from the Netsody network.
///
/// This trait defines the interface for handling incoming messages in a Netsody node.
