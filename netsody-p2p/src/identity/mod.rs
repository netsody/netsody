//! Identity management for the Netsody protocol.
//!
//! This module provides functionality for creating, managing, and persisting
//! cryptographic identities used in the Netsody peer-to-peer network.
//!
//! # Overview
//!
//! An identity in Netsody consists of:
...
//! use netsody_p2p::node::MIN_POW_DIFFICULTY_DEFAULT;
//!
...
/// Represents a complete node identity in the Netsody network.
///
