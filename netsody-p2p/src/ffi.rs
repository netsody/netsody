...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_new(
    recv_buf_cap: usize,
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_free(recv_buf: *mut (MessageSender, MessageReceiver)) -> c_int {
    unsafe {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_tx(
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_rx(
    recv_buf: &mut (MessageSender, MessageReceiver),
) -> *mut MessageReceiver {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_len(
    bind: &mut NodeBind,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_recv_buf_recv(
    bind: &mut NodeBind,
    recv_buf_rx: &mut MessageReceiver,
    sender: *mut u8,
    buf: *mut u8,
...
//
#[unsafe(no_mangle)]
pub extern "C" fn netsody_version() -> *const u8 {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_generate_identity(
    sk_buf: *mut u8,
    pk_buf: *mut u8,
    pow_buf: *mut u8,
    pow_diff: u8,
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_new() -> *mut NodeOptsBuilder {
    Box::into_raw(Box::new(NodeOptsBuilder::default()))
}

#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_id(
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_message_sink(
    builder: &mut NodeOptsBuilder,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_udp_addrs(
    builder: &mut NodeOptsBuilder,
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_udp_port(
    builder: &mut NodeOptsBuilder,
    udp_port: u16,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_udp_port_none(builder: &mut NodeOptsBuilder) -> c_int {
    builder.udp_port(None);
    0
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_arm_messages(
    builder: &mut NodeOptsBuilder,
    arm_messages: bool,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_max_peers(
    builder: &mut NodeOptsBuilder,
    max_peers: u64,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_min_pow_difficulty(
    builder: &mut NodeOptsBuilder,
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_hello_timeout(
    builder: &mut NodeOptsBuilder,
    hello_timeout: u64,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_hello_max_age(
    builder: &mut NodeOptsBuilder,
    hello_max_age: u64,
) -> c_int {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_super_peers(
    builder: &mut NodeOptsBuilder,
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_process_unites(
    builder: &mut NodeOptsBuilder,
    process_unites: bool,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_housekeeping_interval(
    builder: &mut NodeOptsBuilder,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_build(
    builder: *mut NodeOptsBuilder,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_builder_free(builder: *mut NodeOptsBuilder) -> c_int {
    unsafe {
...
// TODO: Netsody_node_opts_id

// TODO: Netsody_node_opts_message_sink

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_udp_port(opts: &mut NodeOpts) -> i32 {
    match opts.udp_port {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_arm_messages(opts: &mut NodeOpts) -> bool {
    opts.arm_messages
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_max_peers(opts: &mut NodeOpts) -> u64 {
    opts.max_peers
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_min_pow_difficulty(opts: &mut NodeOpts) -> u8 {
    opts.min_pow_difficulty
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_hello_timeout(opts: &mut NodeOpts) -> u64 {
    opts.hello_timeout
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_hello_max_age(opts: &mut NodeOpts) -> u64 {
    opts.hello_max_age
}

// TODO: Netsody_node_opts_super_peers

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_mtu(opts: &mut NodeOpts) -> c_int {
    opts.mtu as c_int
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_process_unites(opts: &mut NodeOpts) -> bool {
    opts.process_unites
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_housekeeping_interval(opts: &mut NodeOpts) -> u64 {
    opts.housekeeping_interval
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_udp_sockets(opts: &mut NodeOpts) -> usize {
    opts.udp_sockets
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_enforce_tcp(opts: &mut NodeOpts) -> bool {
    opts.enforce_tcp
}

#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_opts_free(opts: *mut NodeOpts) -> c_int {
    unsafe {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_bind(opts: *mut NodeOpts, bind: *mut *mut NodeBind) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_bind_free(bind: &mut NodeBind) -> c_int {
    unsafe {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_send_to(
    bind: &mut NodeBind,
    recipient: *mut u8,
    buf: *mut u8,
    buf_len: usize,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_peers_list<'a>(
    bind: &'a mut NodeBind,
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_node_udp_port(bind: &mut NodeBind) -> c_int {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peers(
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peers_len(peers: &mut Vec<Peer>) -> u64 {
    peers.len() as u64
}

#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peers_free(peers: &mut Vec<Peer>) -> c_int {
    unsafe {
...
#[allow(clippy::not_unsafe_ptr_arg_deref)]
#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peer_pk(
    peers: &mut Vec<Peer>,
    index: usize,
    pk: *mut u8,
) -> c_int {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peer_super_peer(peers: &mut Vec<Peer>, index: usize) -> c_int {
    match peers.get(index) {
...
#[unsafe(no_mangle)]
pub extern "C" fn netsody_peers_list_peer_reachable(peers: &mut Vec<Peer>, index: usize) -> c_int {
    match peers.get(index) {
