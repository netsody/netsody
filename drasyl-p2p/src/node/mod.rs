//! # Node used to communicate with peers via the drasyl network.
//!
//! This module provides the core networking functionality for the drasyl peer-to-peer network.
...
//! ## Overview
//!
//! The node module is the heart of the drasyl network stack, responsible for:
...
///
/// A `Node` represents a participant in the drasyl network and provides the main interface
