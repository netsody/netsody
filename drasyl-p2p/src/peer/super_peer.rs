//! Super peer management for the drasyl network.
//!
//! This module provides functionality for managing connections to super peers,
//! which act as relay nodes and help with peer discovery in the drasyl network.
...
/// A super peer connection in the drasyl network.
///
