//! # Message type definitions used by the drasyl protocol.
//!
//! This module contains the core message types and utilities for the drasyl peer-to-peer network protocol.
...
//! ## Message Structure
//!
//! All drasyl messages follow a consistent structure with headers containing routing information
...
//! ## Usage
//!
//! This module provides the foundational message types used throughout the drasyl network stack.
...
//!
//! ```rust,ignore
//! use drasyl::message::{AppMessage, LongHeader, MessageError};
//!
...
//! ensuring secure communication between peers in the drasyl network.
